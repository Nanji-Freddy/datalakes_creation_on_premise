...
def iceberg_table_read(*args, **kwargs):
    ...
    #datalists = car_ecommerece , inconsistent_ad_campaign_data_with_cars , fictive_social_media_data , fictive_web_server_logs
    # Construct the full path to the table in the MinIO bucket
    table_name = "local.iceberg_demo.inconsistent_ad_campaign_data_with_cars" 
